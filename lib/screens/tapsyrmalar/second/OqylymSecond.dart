...
class OqylymSecondPage extends StatefulWidget {
  const OqylymSecondPage({super.key});

  @override
  State<OqylymSecondPage> createState() => _OqylymSecondPageState();
}

class _OqylymSecondPageState extends State<OqylymSecondPage> {
  @override
