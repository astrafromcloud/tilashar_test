...
class TyndalymFirstPage extends StatefulWidget {
  const TyndalymFirstPage({super.key});

  @override
  State<TyndalymFirstPage> createState() => _TyndalymFirstPageState();
}

class _TyndalymFirstPageState extends State<TyndalymFirstPage> {
            ...
            onAccept: (String? data) {
              if (data != null) {
                setState(() {
                  ...
                  if (test.toString() == '[португал, сенбі, бесінші, ауыр, күндері]') {
                    btn3(context);
                  }
                });
              }
...
Map<String, String> suraqtar = {
  'Дүйсенбі ': ' тілінде «екінші күн» деген мағынаны білдіреді.',
  'Әр күннің соңындағы ': ' сөзі «күн» деген мағынаны білдіреді.',
  'Аптаның ': ' күні «жұма» деп аталады.',
  'Дүйсенбіні « ': ' күн» деп те атайды.',
  'Біз сенбі, жексенбі ': ' демаламыз.'
};
